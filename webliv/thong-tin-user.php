            ...
            <section class="box-main1">
                ...
                <form action="" method="POST" class="form-horizontal formcustome" role="form" style="margin-top: 20px">	
            		<div class="form-group">
            			...
            			<div class="col-md-5">
            				<input type="text"   name="name" placeholder=" Phạm Văn Thành " class="form-control" value="<?php echo $user['name'] ?>">        				
            			</div>
            		</div>
            		<div class="form-group">
            			<label class="col-md-2 col-md-offset-1"> Email</label>
            			<div class="col-md-5">
            				<input type="email"   name="email" placeholder=" udanchi3105@gmail.com" class="form-control" value="<?php echo $user['email'] ?>">        				
            			</div>
            		</div>
            		<div class="form-group">
            			<label class="col-md-2 col-md-offset-1"> Số điện thoại</label>
            			<div class="col-md-5">
            				<input type="number"  name="phone" placeholder=" 0942495160" class="form-control" 
            		...
            		<div class="form-group">
            			...
            			<div class="col-md-5">
            				<input type="text"   name="address" placeholder="Nam Trực - Nam Định" class="form-control" value="<?php echo $user['address'] ?>">		
            			</div>
            		</div>
