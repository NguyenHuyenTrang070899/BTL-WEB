...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/webliv/public/frontend/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="/webliv/public/frontend/css/bootstrap.min.css">  
        <script  src="/webliv/public/frontend/js/jquery-3.2.1.min.js"></script>
        <script  src="/webliv/public/frontend/js/bootstrap.min.js"></script>
        <link rel="stylesheet" type="text/css" href="/webliv/public/frontend/css/slick.css"/>
        <link rel="stylesheet" type="text/css" href="/webliv/public/frontend/css/slick-theme.css"/>
        <link rel="stylesheet" type="text/css" href="/webliv/public/frontend/css/style.css">
    </head>
    <body>
        <div id="wrapper">
            <div id="header">
                                ...
                                <nav id="header-nav-top">
                                    <ul class="list-inline pull-right" id="headermenu">   
                                        ...
                                        <?php else: ?>
											...
											<li>
                                                <a href="dang-ky-author.php"><i class="fa fa-user"></i> Trở thành tác giả</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </nav>
                ...
                <div class="container">
                    <div class="row" id="header-main">
                        ...
                        <div class="col-md-4">
                            <a href="">
                                <img class="" src="../../webliv/public/frontend/images/Logo2.PNG">
                            </a>
                        </div>
                                    ...
                                    <a href="chi-tiet-san-pham.php?id= <?php echo $item['id'] ?>">
                                       <img src="<?php echo uploads() ?>/product/<?php echo $item['thunbar']?>" width="80px" height="80px" class="img-responsive pull-left">
                                        <div class="info pull-right">
                                            ...
                                            <?php if ($item['sale'] > 0): ?>
                                                <p> <strike class="sale"><?php echo formatPrice($item['price']) ?> </strike> <br><b class="price"><?php echo formatpricesale($item['price'],$item['sale']) ?></b>
                                            <?php else: ?>
