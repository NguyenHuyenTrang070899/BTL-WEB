...
import "../custommer/bootstrap.min.css";
import "../custommer/home.css";
            ...
            <div>
                <div className="ms-container" id="dangnhap">
                                ...
                                <div className="col-sm-10 ml-sm-5 ">
                                    <ul className="nav h-100">
                                        <li className="nav-item h-100">
                                            <a className="nav-link " href="HtmlPage1.html">Trang chủ</a>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link" href="giohang.html">Giỏ hàng</a>
                                        </li>

                                        <li className="nav-item">
                                            <a className="nav-link" href="phanhoi.html">phản hồi</a>
                                        </li>
                    ...
                    <div className="ms-container">
                        <div className="col-sm-6 mx-auto mt-5 mb-5">
                            <h2 className="mx-auto">ĐĂNG NHẬP</h2>
                            <form action="/action_page.php">
                                <div className="form-group">
                                    <label form="email">Your name:</label>
                                    <input type="text" className="form-control"
                                           placeholder=" nhập tên đăng nhập của bạn" name="yourname"/>
                                </div>
                                <div className="form-group">
